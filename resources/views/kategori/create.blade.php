...
<div class="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-lg">
    ...
    <div class="mb-6 border-b pb-3">
        <h4 class="text-2xl font-bold text-gray-800">Tambah Kategori</h4>
        <p class="text-sm text-gray-600 mt-1">
            Silakan tambahkan kategori baru untuk digunakan pada arsip surat.<br>
        </p>
    </div>
    ...
    <form action="{{ route('kategori.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            <label class="block font-semibold text-gray-700 mb-2">ID Kategori</label>
        ...
        <div>
            ...
            <textarea name="keterangan" rows="3"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Tuliskan keterangan kategori (opsional)"></textarea>
        </div>
