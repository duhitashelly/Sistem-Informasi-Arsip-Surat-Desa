...
<div class="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-lg">
    ...
    <div class="mb-6 border-b pb-3">
        <h4 class="text-2xl font-bold text-gray-800">Arsip Surat</h4>
        <p class="text-sm text-gray-600 mt-1">
            Unggah surat yang telah terbit pada form ini untuk diarsipkan.<br>
            <span class="text-red-500 font-medium">Catatan:</span> Gunakan file berformat <b>PDF</b>.
        </p>
    </div>
    ...
    <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="nomor_surat"
                ...
                placeholder="Contoh: 001/IX/2025"
                required>
        </div>
